    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                $query2 = $pdo->query("SELECT * FROM matriculas where aluno = '$id_aluno' order by id desc ");
                $res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
                for ($i=0; $i < count($res2); $i++) { 
                    foreach ($res2[$i] as $key => $value) {
                    }
  
                     $id_turma = $res2[$i]['turma'];
                     $id_mat = $res2[$i]['id'];
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <?php
                                        $query = $pdo->query("SELECT * FROM alunos where nome = '$nome_usu' ");
                                        $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                    ...
                                    ?>
                                    <img class="img-profile rounded-circle" src="../img/alunos/<?php echo $foto ?>">
