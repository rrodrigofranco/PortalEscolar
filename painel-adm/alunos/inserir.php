...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO alunos SET nome = :nome, cpf = :cpf, email = :email, endereco = :endereco, telefone = :telefone, foto = '$imagem'");	
	...
	if($imagem == "sem-foto.jpg"){
		$res = $pdo->prepare("UPDATE alunos SET nome = :nome, cpf = :cpf, email = :email, endereco = :endereco, telefone = :telefone WHERE id = '$id'");
	}else{
		$res = $pdo->prepare("UPDATE alunos SET nome = :nome, cpf = :cpf, email = :email, endereco = :endereco, telefone = :telefone, foto = '$imagem' WHERE id = '$id'");
	}
